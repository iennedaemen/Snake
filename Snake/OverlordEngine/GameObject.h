...
#pragma endregion Template Methods
	...
	void SetFinalDraw(bool isFinal)
	{
		m_IsFinalDraw = isFinal;
	}
	bool IsFinalDraw()
	{
		return m_IsFinalDraw;
	}
...
private:
	...
	// Final draw after post processing
	void FinalDraw(const GameContext& gameContext);

	std::vector<GameObject*> m_pChildren;
	std::vector<BaseComponent*> m_pComponents;

	bool m_IsInitialized, m_IsActive , m_IsFinalDraw;
