...
void RigidBodyComponent::CreateActor()
{
	...
	if (m_isStatic)
		m_pActor = physX->createRigidStatic(physx::PxTransform(ToPxVec3(transform->GetPosition()))); //fix rotations!!!
	else
	{
		m_pActor = physX->createRigidDynamic(physx::PxTransform(ToPxVec3(transform->GetPosition())));
		...
		if (m_InitialConstraints != 0)
		{
			SetConstraint(RigidBodyConstraintFlag::RotX,
				static_cast<bool>((m_InitialConstraints & (int)RigidBodyConstraintFlag::RotX) == (int)RigidBodyConstraintFlag::RotX));
			SetConstraint(RigidBodyConstraintFlag::RotY,
				static_cast<bool>((m_InitialConstraints & (int)RigidBodyConstraintFlag::RotY) == (int)RigidBodyConstraintFlag::RotY));
			SetConstraint(RigidBodyConstraintFlag::RotZ,
				static_cast<bool>((m_InitialConstraints & (int)RigidBodyConstraintFlag::RotZ) == (int)RigidBodyConstraintFlag::RotZ));
			SetConstraint(RigidBodyConstraintFlag::TransX,
				static_cast<bool>((m_InitialConstraints & (int)RigidBodyConstraintFlag::TransX) == (int)RigidBodyConstraintFlag::TransX));
			SetConstraint(RigidBodyConstraintFlag::TransY,
				static_cast<bool>((m_InitialConstraints & (int)RigidBodyConstraintFlag::TransY) == (int)RigidBodyConstraintFlag::TransY));
			SetConstraint(RigidBodyConstraintFlag::TransZ,
				static_cast<bool>((m_InitialConstraints & (int)RigidBodyConstraintFlag::TransZ) == (int)RigidBodyConstraintFlag::TransZ));
		}
	}
...
#pragma warning(pop)
	...
	{
		m_InitialConstraints |= enable ? (int)flag : ~(int)flag;
	}
}
